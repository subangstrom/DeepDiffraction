...
%%
tic
for i_list=1:120 %set thickness, parfor compatible, but it is recommended to run multiple instances
    num=uint32(0);
    ...
    parsave(['image_sum_thickness_',num2str(i_list),'_14mrad.mat'],image_sum,num) %save mean data of the image
end
toc
exit