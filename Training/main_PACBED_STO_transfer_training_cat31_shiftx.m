...
layersTransfer(end+1) = dropoutLayer(0.5);
layersTransfer(end+1) = fullyConnectedLayer(31,...
...
inputlayer = imageInputLayer([227 227 3],'DataAugmentation','none');
...
optionsTransfer = trainingOptions('sgdm','MaxEpochs',3,...
    ...
    'MiniBatchSize',84,...
    'CheckpointPath',digitDatasetPath_train); %0.0002at beginning
